package com.otacodes.onrentservices.Fragment;
...
import com.otacodes.onrentservices.Activity.AddPropertyActivity;
import com.otacodes.onrentservices.Activity.AllBeritaActivity;
import com.otacodes.onrentservices.Activity.AllPopularActivity;
import com.otacodes.onrentservices.Activity.AllPropActivity;
import com.otacodes.onrentservices.Activity.LoginFormActivity;
import com.otacodes.onrentservices.Constants.BaseApp;
import com.otacodes.onrentservices.Constants.Constants;
import com.otacodes.onrentservices.Item.BeritaItem;
import com.otacodes.onrentservices.Item.CategoryItem;
import com.otacodes.onrentservices.Item.CityItem;
import com.otacodes.onrentservices.Item.GridItem;
import com.otacodes.onrentservices.Item.SliderItem;
import com.otacodes.onrentservices.Models.BeritaModels;
import com.otacodes.onrentservices.Models.CategoryModels;
import com.otacodes.onrentservices.Models.CityModels;
...
import com.otacodes.onrentservices.Utils.NetworkUtils;
...
public class HomeFragment extends Fragment {
    ...
    private void getCategory() {
        ...
        Log.e("respogeparameters","parameters" + parameters);
        ...
        (Request.Method.POST, Constants.CATEGORY, parameters, new Response.Listener<JSONObject>() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        // TODO: Handle error
                        Log.e("respogetCategory",error.toString());
                    }
                });
        jsonObjectRequest.setRetryPolicy(new DefaultRetryPolicy(30000,
                DefaultRetryPolicy.DEFAULT_MAX_RETRIES,
