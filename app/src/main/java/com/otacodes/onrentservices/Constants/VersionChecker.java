package com.otacodes.onrentservices.Constants;
...
// this class will get the latest version of onrentservices from playtore if the onrentservices is publish into playstore
    ...
    protected void onPostExecute(String s) {
        ...
        if(!Constants.versionname.equals(latestVersion) && (latestVersion!=null)){
            ...
            alert.setTitle(R.string.app_name)
                    ...
                    .setMessage("Please update" +" "+ R.string.app_name+" "+"onrentservices. you have an old version.")
